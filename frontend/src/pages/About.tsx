    ...
    const team = [
        {
            ...
            fullBio: "Stacie Mwangi is the Founder and Executive Director of Ubuntu Nexus.\n\nShe is a distinguished Criminal Justice graduate from the United States International University-Africa, where she was the recipient of the 2024 Community Service Award. She has experience in multilateral engagement, policy, governance, criminal justice and youth empowerment, working across international institutions, community-based initiatives, and academic programs.\n\nAt the Office of the Special Representative of INTERPOL to the United Nations in New York, Stacie contributed to multilateral engagement, diplomacy, and policy analysis in areas including international security, law enforcement, counter-terrorism, and criminal justice cooperation. She also worked as a Legal Intern at the United Nations International Residual Mechanism for Criminal Tribunals in Arusha, conducting legal research and supporting international criminal justice processes.\n\nStacie was an Imara Fellow at Siasa Place, a program that seeks to empower the next generation of policy leaders. Through this program, she co-facilitated three community engagement forums in Kajiado County between the youth and the county government, fostering dialogue on local governance, youth participation and development challenges. As a Lead(H)er Fellow under YouLead Africa, focusing on Peace and Security, Stacie gained practical skills in Pan-African leadership and feminist leadership, rooted in the values of Ubuntu, and designed actionable proposals to advance youth-led solutions.\n\nIn addition to her international and policy work, Stacie has a track record of leadership and service in academic and community initiatives. She chaired the Criminal Justice Club at USIU-Africa, leading it to be recognized as the Most Outstanding Club of the Year 2024, convened the inaugural Criminal Justice Week, and served in the organizing committees of the 7th and 8th Criminology and Criminal Justice Conference, as well as Amnesty International Kenya’s 2023 Annual Delegates Conference. She has also conducted a Training of Trainers on Peacebuilding and Conflict Transformation, equipping young leaders with tools to lead peace efforts in their communities.\n\nBeyond this, Stacie is a certified mediator (Amani Communities Africa), certified in Cyber Security (ISC2) and holds certificates in Peace Negotiations (Public International Law & Policy Group), and Youth, Peace, and Security (UNSSC).\n\nAt Ubuntu Nexus, Stacie leverages her expertise to strengthen youth and community agency through structured programs, dialogue, and institutional engagement, grounded in the belief that justice and peace are outcomes of inclusion, participation, and accountable systems. Her work reflects a deep commitment to building safe, inclusive, dignified, and cohesive communities, rooted in the spirit of Ubuntu, where shared humanity and dignity are not aspirations but foundations.",
        ...
        },
        {
            ...
            fullBio: "William is the Lead for Digital Operations and Creative Systems at Ubuntu Nexus. Based in Nairobi, he is currently pursuing a Degree in Software Engineering, bringing a multi-disciplinary, security-first mindset to his work. He possesses a strong foundation in full-stack development, digital infrastructure architecture, and UI/UX design, allowing him to seamlessly bridge the gap between complex backend systems and intuitive digital experiences.\n\nIn his technical practice, William operates at the intersection of robust development and proactive threat mitigation. A strong advocate for defense-in-depth strategies, he is the principal architect of Project Nocturne, an advanced, AI-integrated SIEM (Security Information and Event Management), EDR, and WAF solution designed for automated threat reporting and response. His deep interest in blue team operations and digital forensics drives his pursuit of creating secure digital environments that anticipate vulnerabilities and prioritize technical transparency.\n\nBeyond enterprise-level security, William is a hands-on technologist with a passion for building highly efficient, localized solutions. He frequently develops custom, lightweight applications and hardware integrations designed to optimize daily workflows and sync across devices. This maker-mindset reflects his broader approach to software engineering: building tools that are functional, resource-efficient, and highly adaptable to user needs.\n\nIn addition to his engineering work, William leverages his background in graphic design to ensure that security and functionality never come at the expense of usability. Outside of the terminal, he is an avid gamer with a deep appreciation for expansive world-building and narrative lore, such as the Warhammer universe—an interest that mirrors his professional appreciation for complex, interconnected systems and strategic foresight.\n\nComplementing his degree studies, William holds a Google Cybersecurity Certificate, a certificate in Graphic Design, and is currently pursuing his Certified Ethical Hacker (CEH) certification to further solidify his expertise in proactive security testing and network defense.\n\nAt Ubuntu Nexus, William leverages his technical acumen to spearhead the organization's overarching digital presence and secure its operational frameworks. His work is grounded in the belief that robust, scalable, and secure digital platforms are essential for effective community engagement. By ensuring the organization's technological infrastructure remains streamlined and protected, William builds the secure foundations that allow the mission of Ubuntu Nexus to thrive in the digital space.",
        ...
        },
        {
            ...
            fullBio: "Benjamin Kitonga is the Research Lead at Ubuntu Nexus. He is a researcher, youth engagement practitioner, and Master’s student with a background in International Relations and Criminal Justice from the United States International University–Africa. His work sits at the intersection of governance, accountability, and youth participation, with a strong focus on democratic resilience and civic space across Africa.\n\nBenjamin has actively engaged in regional forums and multi-stakeholder dialogues, bringing forward practical, youth-driven perspectives on justice, institutional trust, and reform. His experience spans research, advocacy, and convening, including moderating and shaping discussions on criminal justice, ethics, and public accountability. Beyond his professional work, he is an award-winning mooter and researcher, and has represented the United States International University–Africa, and the African region at the International Chamber of Commerce Mediation Competition in Hong Kong. He is particularly interested in how systems can be made more responsive, transparent, and inclusive, especially for young people navigating governance structures.",
    ...
    const fsbMembers = [
        {
            ...
            image: "/images/staff/Karlijn van der Poel.jpeg",
            socials: {}
        },
        {
            id: 'fsb-samuel',
            name: "Samuel Baraka",
            role: "Founding Strategic Board",
            bio: "Lawyer, certified professional mediator, and researcher focusing on governance and Alternative Dispute Resolution (ADR) to expand access to justice across Africa.",
            fullBio: "Samuel Baraka is a lawyer, certified professional mediator, and researcher with a growing focus on governance and Alternative Dispute Resolution (ADR). His work is driven by a commitment to fairness, access to justice, and the development of progressive, people-centred legal solutions.\n\nWith a strong foundation in law, Samuel has a particular interest in the intersection of Alternative Dispute Resolution and restorative justice. He has served as Secretary General of the Young Arbiters Society, Riara University Chapter and worked with law firms, think tanks, and civil society organisations in both the public and private sectors.\n\nSamuel's broader work includes thought leadership, public engagement, and supporting initiatives that seek to demystify legal processes and expand access to justice across Africa. He is passionate about contributing to a more responsive, equitable, and forward-looking justice system.",
            image: "/images/staff/Samuel Baraka.jpeg",
            socials: {}
        }
    ];
                    ...
                    <div className="mt-20 pt-16 border-t border-slate-100">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
                            {fsbMembers.map((fsb, idx) => (
                                ...
                                >
                                    <div
                                        className={`w-full sm:w-2/5 h-48 sm:h-auto relative flex items-center justify-center ${fsb.image ? 'bg-slate-100' : 'bg-slate-50'
                                            } filter grayscale group-hover:grayscale-0 transition-all duration-500`}
                                    >
                                        {fsb.image ? (
            ...
            <section className="py-24">
                <div className="container mx-auto px-6 max-w-4xl text-center">
                    ...
                    <div className="prose prose-lg mx-auto text-slate-600">
                        ...
                        <p className="mt-4">
                            Justice and peace, in our view, are not starting points.
                        </p>
                        <p className="mt-4">
